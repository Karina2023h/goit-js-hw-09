...
const imputDaterRef = getRef('#datetime-picker');
...
// Initial flatpickr
flatpickr(imputDaterRef, options);
...
window.addEventListener('keydown', e => {
  if (e.code === 'Escape' && timerId) {
    ...
    imputDaterRef.removeAttribute('disabled');
    btnStartRef.setAttribute('disabled', true);
...
function startTimer() {
  btnStartRef.setAttribute('disabled', true);
  imputDaterRef.setAttribute('disabled', true);
